...
| **Purpose**      | Product billing events → Metronome (MCP, LLM tokens, AI messages)  | GMS API traffic → Micrometer (+ SaaS commercial overlay)     |
| **Entry**        | `BillingHandler`, `POST /openapi/v1/billing/usage`                 | `UsageMetricsSessionEnricher`, tagged HTTP controllers       |
